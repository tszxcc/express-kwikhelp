...
async function authorize(req, res, next) {
    ...
    if (!accessToken) {
        ...
        const refreshTokenExist = await authService.refreshTokenExist(
            refreshToken
        );
        ...
        if (refreshTokenExist) {
            ...
            const newAccessToken = accessTokenUtil.generateAccessToken(
                refreshTokenExist.username,
                refreshTokenExist.role
            );
